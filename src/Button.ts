...
export class Button {
  ID?: string;
  scale = 1;
  constructor(public name: string, public roomPosition: IPosition, public modelPath: string, public groupID: string = "", public callback: (id?: string) => void = () => { }, hidden?: boolean) {
